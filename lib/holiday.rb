...
holiday_hash.each do |season, holiday_names_hash|
holiday_names_hash.each do |holiday_names_hash, supplies|
  if holiday_names_hash == :memorial_day
    supplies << supply
  end 
end 
end
...
holiday_hash.each do |season, holiday_name_with_supply|
  puts "#{season.to_s.capitalize}:"
  holiday_name_with_supply. each do |holiday, supplies|
