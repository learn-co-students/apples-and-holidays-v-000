...
def all_winter_holiday_supplies(holiday_hash)
  ...
  if season == :winter
    holiday.collect do |holiday_name, supply|
      ...
      supplies.flatten  # return an array of all of the supplies that are used in the winter season
end
  ...
  holiday_hash.each do |season, holiday|
    ...
    puts "#{season}:"
      holiday.each do |holiday_name, supplies|
        ...
        holiday_name.map {|word| word.capitalize!}
  ...
  holiday_hash.each do |season, holiday|
    holiday.each do |holiday_name, supply|
      if supply.include?("BBQ")
        all_holidays_with_bbq << holiday_name
      end
    end
  end
  all_holidays_with_bbq
