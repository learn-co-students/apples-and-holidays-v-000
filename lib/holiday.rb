...
def all_winter_holiday_supplies(holiday_hash)
  winter_supplies = []
  holiday_hash[:winter].each { |holiday, supplies| winter_supplies << supplies }
...
def all_supplies_in_holidays(holiday_hash)
  ...
  puts "#{season.capitalize}:"
    holidays.each do |holiday, supplies|
      ...
      # .split splits a string into an array based on a delimiter eg ("_")
      # .map iterates over the array, and returns a new array
      # .join converst the array into a string, based on a delimiter
