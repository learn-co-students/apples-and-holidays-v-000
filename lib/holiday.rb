...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  #can approach this by iterating through the hash through each level
  ...
  #can refactor above code as follows:
  holiday_hash[:winter].each do |season, supplies|
    supplies << supply
  end
  
  #or add supply manually to each array as follows:
...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, holidays|
    #need to convert symbols into strings first
