...
def all_supplies_in_holidays(holiday_hash)
  ...
  # Winter: (season)
  #   Christmas(holidays): Lights, Wreath
  ...
  holiday_hash.each do |season, holidays|
    ...
    holidays.each do |holiday, supplies|
      # holiday => :cristmas supplies => ["Lights", "Wreath"]
      # To correct words like New_year to New Year
      normalized_holiday_name = holiday.to_s.split("_").
        collect {|w| w.capitalize}.join(" ")
