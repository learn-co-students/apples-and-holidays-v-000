...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  holiday_supplies[:winter].each do |holiday, supplies_array|
...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, season_details|
    ...
    season_details.each do |holiday, supplies|
      holiday_caps = holiday.to_s.split("_").each do |holiday_word|
...
def all_holidays_with_bbq(holiday_hash)
  ...
  x = [] #where we will accumulate holidays with BBQs
  holiday_hash.each do |season, season_details|
    season_details.each do |holiday, supplies|
