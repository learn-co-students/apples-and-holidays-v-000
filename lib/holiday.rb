...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, holiday_name_hash|
  	...
  	holiday_name_hash.each do |holiday, supplies|
				...
				holiday_array.map {|holiday_array_element| holiday_array_element.capitalize!}
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_names_array = []
  holiday_hash.collect do |seasons, holiday_name_hash|
    holiday_name_hash.collect do |holiday, supplies|
	     if supplies.include?("BBQ")
	  		    holiday_names_array << holiday
	     end
  	end
  end
  holiday_names_array
